 ...
 * @author Tatiana
 */
public class panelEditarCurso extends javax.swing.JPanel {
    ...
    public panelEditarCurso(Curso curso) {
        this.curso = curso;
        initComponents();
    ...
    private void initComponents() {
        ...
        txtNombreAntiguo = new javax.swing.JTextField();
        ...
        txtIDCurso.setBackground(new java.awt.Color(223, 223, 249));
        txtIDCurso.setFont(new java.awt.Font("Yu Gothic UI", 0, 12)); // NOI18N
        txtIDCurso.setForeground(new java.awt.Color(102, 102, 102));
        txtIDCurso.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtIDCurso.setActionCommand("<Not Set>");
        txtIDCurso.setBorder(null);
        txtIDCurso.setOpaque(true);
        ...
        txtNombreAntiguo.setEditable(false);
        txtNombreAntiguo.setBackground(new java.awt.Color(223, 223, 249));
        txtNombreAntiguo.setFont(new java.awt.Font("Yu Gothic UI", 1, 18)); // NOI18N
        txtNombreAntiguo.setForeground(new java.awt.Color(102, 102, 102));
        txtNombreAntiguo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNombreAntiguo.setActionCommand("<Not Set>");
        txtNombreAntiguo.setBorder(null);
        txtNombreAntiguo.setOpaque(true);
            ...
            .addGroup(pDatosCursoLayout.createSequentialGroup()
                .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pDatosCursoLayout.createSequentialGroup()
                        ...
                        .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pDatosCursoLayout.createSequentialGroup()
                                .addComponent(jLabel11, javax.swing.GroupLayout.DEFAULT_SIZE, 443, Short.MAX_VALUE)
                    ...
                    .addGroup(pDatosCursoLayout.createSequentialGroup()
                        .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(pDatosCursoLayout.createSequentialGroup()
                                        ...
                                        .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtIDCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(pDatosCursoLayout.createSequentialGroup()
                            ...
                            .addGroup(pDatosCursoLayout.createSequentialGroup()
                                .addGap(85, 85, 85)
                                .addComponent(txtNombreAntiguo, javax.swing.GroupLayout.PREFERRED_SIZE, 442, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        pDatosCursoLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pDatosCursoLayout.createSequentialGroup()
                ...
                .addComponent(txtNombreAntiguo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txtIDCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(pDatosCursoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pDatosCurso, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 619, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pDatosCurso, javax.swing.GroupLayout.DEFAULT_SIZE, 798, Short.MAX_VALUE)
        );
    ...
    private void btModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btModificarActionPerformed
        ...
        if (!horarioCompl.equals(curso.getHorario())) {
    ...
    public javax.swing.JTextField txtNombreAntiguo;
    ...
    private void cargarDatosCurso() {
        try {
            ...
            String nombreSinHorario = nombre.substring(0, nombre.length() - 4);
            txtIDCurso.setText(Integer.toString(curso.getId()));
            txtNombreAntiguo.setText(nombre);
            txtNombre.setText(nombreSinHorario);
            txtCapacidad.setText(Integer.toString(curso.getCapacidad()));
            txtDescripcion.setText(curso.getDescripcion());
            txtCuota.setText(Integer.toString(curso.getCuota()));

            String profe = curso.getProfesor().getNombre() + " " + curso.getProfesor().getApellidos();
            cmbProfesores.setSelectedItem(profe);
    ...
    private void cargarDatosHorario(String horario) {
        ...
        for (Map.Entry<String, String> entry : dias.entrySet()) {
            if (entry.getKey().equals(dia)) {
                diaComp = entry.getValue();
            }
        }
        cmbDias.setSelectedItem(diaComp);

        String hora = horario.substring(1);
        String horaComp = "";

        for (Map.Entry<String, String> entry : horas.entrySet()) {
            if (entry.getKey().equals(hora)) {
                horaComp = entry.getValue();
            }
        }
        cmbHorario.setSelectedItem(horaComp);
    }
}
